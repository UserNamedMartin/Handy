...
pub use audio::{
    ...
    read_wav_samples, save_wav_file, verify_wav_file, whisper_autogain, AudioRecorder, CaptureDebug,
    CpalDeviceInfo, SegmentClose, StreamSegmenter, StreamSegmenterConfig, VadPolicy,
};
